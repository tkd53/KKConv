...
# ��  ǽ : ñ��(ɽ��) 2-gram �Υ����ѥ����Ф�������
#
# ����ˡ : CorpusStatWithStochSegText.perl (STEP) (STEM) [FILENAME]
#
# ��  �� : CorpusStatWithStochSegText.perl 0 MMH-L MMH-T.morp
#
...
while (<CORPUS>){                                 # ʸñ�̤Υ롼��
    ...
    @word = &Morphs2Words($_);                    # ʸ���������ޤޤʤ�
    $Tword += @word;
    $Tknown += scalar(grep(($WordIntStr->int($_) || $text->Freq($_) > 0), @word));
}
close(CORPUS);
warn "\n";
