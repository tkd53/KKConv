...
# add(Int, STATE, STATE, STATE, STATE);
#
# 機  能 : <STATE, STATE, STATE, STATE> の頻度に Int を加える。
...
# inc(STATE, STATE, STATE, STATE);
#
# 機  能 : <STATE, STATE, STATE, STATE> の頻度をインクリメントする。
...
# _4gram(Number, Number, Number, Number)
#
# 機  能 : 4-gram の頻度
#          Number : 状態の番号
...
sub _4gram{
    ...
    return($$self{pack("I" x 5, (@_, 0))});
#    return($$self{pack("IIII", @_)});
}
